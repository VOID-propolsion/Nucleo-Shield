...
#define MEM_SECTOR_SIZE 4096U // 4 KB : 16 pages
...
/// Pages count
#define PAGE_COUNT (SECTOR_COUNT * 16) // 65,536 pages
    ...
    W25Q_STATE W25Q_ReadSector(u8_t *buf, u32_t sectorNum, u32_t bytes_to_read_upto_sector_size, u32_t offset);     ///< Read any 8-bit data
    W25Q_STATE W25Q_Read_Page_SingleSPI(u8_t *buf, u32_t pageNum, u32_t bytes_to_read_upto_pagesize, u32_t offset); ///< Read data from raw addr by single line
    W25Q_STATE W25Q_Read_Page_DualIO(u8_t *buf, u16_t len, u32_t pageNum);                                          ///< Read data from raw addr
    ...
    W25Q_STATE W25Q_ProgramSector(u8_t *buf, u32_t sector_num, u32_t bytes_to_write_upto_sector_size, u32_t offset); ///< Program any 8-bit data
    W25Q_STATE W25Q_ProgramPage(u8_t *buf, u32_t pageNum, u32_t bytes_to_write_upto_pagesize, u32_t offset);         ///< Program data to raw addr
